...
* *Credenciales y permisos*: Debes tener link:https://docs.netapp.com/us-en/workload-setup-admin/add-credentials.html["Credenciales de la cuenta de AWS y permisos de _operaciones y remediación_"^] para crear un clon de entorno de pruebas en Workload Factory.
+

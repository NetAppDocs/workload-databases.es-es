...
---
= Analiza los registros de errores en NetApp Workload Factory for Databases
:allow-uri-read: 
:icons: font
:imagesdir: ./media/
...
NOTE: Si el administrador de tu cuenta ha desactivado las funciones de IA, aparecerá un mensaje y no podrás utilizar el análisis de IA. Ponte en contacto con tu administrador o link:https://docs.netapp.com/us-en/workload-setup-admin/manage-genai-features.html["conoce la administración de IA"^].

...
La fábrica de cargas de trabajo ofrece una calculadora de ahorro para que puedas comparar distintos componentes de coste al ejecutar cargas de trabajo de Microsoft SQL Server, como el almacenamiento, la computación, la licencia de SQL, los snapshots y los clones para las cargas de trabajo de tus bases de datos en sistemas de archivos FSx para ONTAP en Elastic Block Store (EBS), FSx para el servidor de archivos de Windows y el almacenamiento on-premises. Dependiendo de sus requisitos de almacenamiento, puede darse cuenta de que los sistemas de archivos de FSx para ONTAP son los más rentables para las cargas de trabajo de sus bases de datos.

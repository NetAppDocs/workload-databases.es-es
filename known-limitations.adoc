...
== Integración con la BlueXP backup and recovery

Después de agregar hosts a la copia de seguridad y recuperación de BlueXP para protección, la detección de la base de datos a veces falla.

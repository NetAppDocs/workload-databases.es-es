...
.Antes de empezar
Cumple los siguientes requisitos previos antes de crear una nueva base de datos.

* *Credenciales y permisos*: Debes tener link:https://docs.netapp.com/us-en/workload-setup-admin/add-credentials.html["Credenciales de la cuenta de AWS y permisos de _operaciones y remediación_"^] para crear una nueva base de datos en Workload Factory.
+

...
summary: Conecta un clon sandbox a una canalización CI y CD con código de API de REST para mejorar la entrega de software mediante la automatización. 
---
= Conecta un clon de sandbox a CI/CD en NetApp Workload Factory for Databases
:allow-uri-read: 
:icons: font
:imagesdir: ./media/
